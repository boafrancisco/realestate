            ...
            <div class="auto-container">
                <div class="inner-container">
                    <div class="content-box centred">
                        <h2>Crie riqueza duradoura por meio de GestaOnline-IMOBI</h2>
                        <p>A Solução Para os Seus Sonhos.</p>
                    </div>
                        ...
                        <div class="tabs-box">
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons centred clearfix">
                                    ...
                                    <li class="tab-btn" data-tab="#tab-2">ALUGUER</li>
                                </ul>
                            </div>
                                        ...
                                        <div class="top-search">
                                            <form action="index.html" method="post" class="search-form">
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                        <div class="form-group">
                                                            <label>Procurar Propriedade</label>
                                                            <div class="field-input">
                                                                <i class="fas fa-search"></i>
                                                                <input type="search" name="search-field" placeholder="PROCURAR PROPRIEDADE, LOCALIZAÇÃO OU OBRAS..." required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                ...
                                                                <select class="wide">
                                                                   <option data-display="Input location">Inserir Localização</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="All Type">Todos os Tipos</option>
                                                ...
                                                <div class="search-btn">
                                                    <button type="submit"><i class="fas fa-search"></i>Pesquisa</button>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="switch_btn_one ">
                                            <button class="nav-btn nav-toggler navSidebar-button clearfix search__toggler">Pesquisa Avançada<i class="fas fa-angle-down"></i></button>
                                            <div class="advanced-search">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            <label>Distância da Localização</label>
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="Distance from Location">Distância da Localização</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="Most Popular">Mais Procurado</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="Any Agency">Qualquer Agência</option>
                                        ...
                                        <div class="top-search">
                                            <form action="index.html" method="post" class="search-form">
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                        <div class="form-group">
                                                            <label>Procure Propriedade</label>
                                                            <div class="field-input">
                                                                <i class="fas fa-search"></i>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <i class="far fa-compass"></i>
                                                                <select class="wide">
                                                                   <option data-display="Input location">Introduza a Localização</option>
                                                                   <option value="1">New York</option>
                                                                   <option value="2">California</option>
                                                                   <option value="3">London</option>
                                                                   <option value="4">Maxico</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="All Type">Todos os Tipos</option>
                                                                   <option value="1">Lauxo</option>
                                                                   <option value="2">Clássico</option>
                                                                   <option value="3">Moderno</option>
                                        ...
                                        <div class="switch_btn_one ">
                                            ...
                                            <div class="advanced-search">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            <label>Distância do Local</label>
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="Distance from Location">Distância da Localização</option>
                                                                   <option value="1">Max Bath</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="Most Popular">Mais Procurados</option>
                                                                   <option value="1">Top Rating</option>
                                                                   <option value="2">New Rooms</option>
                                                                   <option value="3">Classic Rooms</option>
                                                                   <option value="4">Luxry Rooms</option>
                                                ...
                                                <div class="range-box">
                                                    <div class="row clearfix">
                                                        <div class="col-lg-6 col-md-6 col-sm-12 column">
                                                            <div class="price-range">
                                                                <h6>Selecciona o Intervalo dos Preços</h6>
                                                                <div class="range-input">
                                                                    <div class="input"><input type="text" class="property-amount" name="field-name" readonly=""></div>
                                                                </div>
                                                                <div class="price-range-slider"></div>
