                ...
                <div class="top-inner clearfix">
                    <div class="left-column pull-left">
                        <ul class="info clearfix">
                            <li><i class="far fa-map-marker-alt"></i>Av. 25 de Setembro, Cidade de Maputo, Moçambique</li>
                            <li><i class="far fa-clock"></i>Seg - Sáb  9.00 - 18.00</li>
                            <li><i class="far fa-phone"></i><a href="tel:2512353256">+258-840-000000</a></li>
                        </ul>
                    </div>
                    <div class="right-column pull-right">
                        ...
                        <div class="sign-box">
                            <a href="signin.html"><i class="fas fa-user"></i>Aceder</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <nav class="main-menu navbar-expand-md navbar-light">
        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
            <ul class="navigation clearfix">
                <li class="current dropdown"><a href="index.html"><span>Ínicio</span></a>
                    <ul>
                        <li><a href="index.html">Página Principal</a></li>
                        <li><a href="index-2.html">Casa Moderna</a></li>
                ...
                <li class="dropdown"><a href="index.html"><span>Listagem</span></a>
                    <ul>
                ...
                <li class="dropdown"><a href="index.html"><span>Propriedade</span></a>
                    <ul>
                ...
                <li class="dropdown"><a href="index.html"><span>Páginas</span></a>
                    <div class="megamenu">
                        <div class="row clearfix">
                            <div class="col-xl-4 column">
                                <ul>
                                    ...
                                    <li><a href="compare-roperties.html">Compare as Propriedades</a></li>
                                    <li><a href="categories.html">Página de Categorias</a></li>
                                    <li><a href="career.html">Oportunidades de Carreira</a></li>
                            ...
                            <div class="col-xl-4 column">
                                <ul>
                                    <li><h4>Pages</h4></li>
                                    <li><a href="gallery.html">Bossa Galeria</a></li>
                                    <li><a href="profile.html">Meu Perfil</a></li>
                                    <li><a href="signin.html">Aceder</a></li>
                                    <li><a href="signup.html">Subscrever</a></li>
                ...
                <li class="dropdown"><a href="index.html"><span>Agência</span></a>
                    <ul>
                        <li><a href="agency-list.html">Lista de Agências</a></li>
                        <li><a href="agency-grid.html">Grelha de Agências</a></li>
                        <li><a href="agency-details.html">Detalhes das Agências</a></li>
                    </ul>
                </li>
...
<div class="btn-box">
    <a href="index.html" class="theme-btn btn-one"><span>+</span>Adicionar Listagem</a>
</div>
</div>
</div>
</div>
