<section class="feature-section sec-pad bg-color-1">
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <h2>Características da Propriedade</h2>
                        ...
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <span class="category">Características</span>
                                </div>
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        ...
                                        <div class="buy-btn pull-right"><a href="property-details.html">Para compra</a></div>
                                    </div>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        ...
                                        <div class="buy-btn pull-right"><a href="property-details.html">Para Aluguer</a></div>
                                    </div>
                                    <div class="title-text"><h4><a href="property-details.html">Apartamentos Contemporâneos</a></h4></div>
                                    <div class="price-box clearfix">
                                        <div class="price-info pull-left">
                                            <h6>Start From</h6>
                                            <h4>$45,000.00</h4>
                                    ...
                                    <div class="btn-box"><a href="property-details.html" class="theme-btn btn-two">Veja Detalhes</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        ...
                                        <div class="buy-btn pull-right"><a href="property-details.html">Vendido</a></div>
                                    </div>
                ...
                <div class="more-btn centred"><a href="property-list.html" class="theme-btn btn-one">Ver Todas Listagens</a></div>
            </div>
        </section>